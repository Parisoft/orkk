...
SELECT *
FROM "public".table
NATURAL LEFT OUTER JOIN generate_series(1, 2)
...
SELECT *
FROM "public".table
NATURAL LEFT OUTER JOIN LATERAL generate_series(1, 2)
...
SELECT *
FROM "public".table
NATURAL LEFT OUTER JOIN LATERAL ROWS FROM(generate_series(1, 2))
...
SELECT *
FROM "public".table
NATURAL LEFT OUTER JOIN ONLY "public".table2
╔═ select * from table natural left outer join rows from(generate_series(1, 2)) ═╗
SELECT *
FROM "public".table
NATURAL LEFT OUTER JOIN ROWS FROM(generate_series(1, 2))
...
SELECT *
FROM "public".table
NATURAL LEFT OUTER JOIN "public".table2
...
SELECT
  ...
  f2
FROM "public".table
NATURAL LEFT OUTER JOIN generate_series(1, 2) AS (f1, f2)
╔═ select f1, f2 from table natural left outer join lateral generate_series(1, 2) as (f, f2) ═╗
SELECT
  f1,
  f2
FROM "public".table
NATURAL LEFT OUTER JOIN LATERAL generate_series(1, 2) AS (f1, f2)
...
SELECT t2.*
FROM "public".table AS t
NATURAL LEFT OUTER JOIN generate_series(1, 2) AS t2
...
SELECT t2.*
FROM "public".table AS t
NATURAL LEFT OUTER JOIN LATERAL generate_series(1, 2) AS t2
...
SELECT t2.*
FROM "public".table AS t
NATURAL LEFT OUTER JOIN ONLY "public".table2 AS t2
╔═ select t2.* from table as t natural left outer join table2 as t2 ═╗
SELECT t2.*
FROM "public".table AS t
NATURAL LEFT OUTER JOIN "public".table2 AS t2
...
SELECT t2.f
FROM "public".table AS t
NATURAL LEFT OUTER JOIN generate_series(1, 2) AS t2(f)
...
SELECT t2.f
FROM "public".table AS t
NATURAL LEFT OUTER JOIN LATERAL generate_series(1, 2) AS t2(f)
...
SELECT t2.f
FROM "public".table AS t
NATURAL LEFT OUTER JOIN ONLY "public".table2 AS t2(f)
╔═ select t2.f from table as t natural left outer join table2 as t2(f) ═╗
SELECT t2.f
FROM "public".table AS t
NATURAL LEFT OUTER JOIN "public".table2 AS t2(f)
